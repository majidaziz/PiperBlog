...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg_email_field = findViewById(R.id.email_text);
        reg_pass_field = findViewById(R.id.pass_text);
        reg_confirm_pass_field = findViewById(R.id.confirm_pass_text);
        reg_btn = findViewById(R.id.create_account_btn);
        reg_login_btn = findViewById(R.id.has_account_btn);
